...
For a more detailed explanation of simplex noise parameters, see [the main mod article](/Syntax/PQSMods/LandControl/LandControl#noise-control).
...
### How precisely does density work?
